  ...
  return (
    <div className={`flex justify-between items-center h-16 ${isDarkMode ? 'dark:bg-gray-800' : 'bg-white'} px-4`}>
      ...
      <div className="relative">
       ...
       <div className="absolute top-[627px] left-[-900px] rounded-10xs bg-blue-500 shadow-[0px_4px_8px_rgba(0,_0,_0,_0.05)] w-[124.8px] flex flex-row items-center justify-start py-2.5 px-[30px] box-border text-sm text-white">
